...
<head>
	...
	<title>Kisan Se - Admin Panel</title>
	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a href="index.php" class="logo">
				<span class="logo-lg">Kisan Se</span>
			</a>
      			...
      			<ul class="sidebar-menu">
                    ...
                    <li class="treeview <?php if( ($cur_page == 'weight.php') || ($cur_page == 'weight-add.php') || ($cur_page == 'weight-edit.php') || ($cur_page == 'district.php') || ($cur_page == 'district-add.php') || ($cur_page == 'district-edit.php') || ($cur_page == 'shipping-cost.php') || ($cur_page == 'shipping-cost-edit.php') || ($cur_page == 'top-category.php') || ($cur_page == 'top-category-add.php') || ($cur_page == 'top-category-edit.php') || ($cur_page == 'mid-category.php') || ($cur_page == 'mid-category-add.php') || ($cur_page == 'mid-category-edit.php') || ($cur_page == 'end-category.php') || ($cur_page == 'end-category-add.php') || ($cur_page == 'end-category-edit.php') ) {echo 'active';} ?>">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="weight.php"><i class="fa fa-circle-o"></i> Weight</a></li>
