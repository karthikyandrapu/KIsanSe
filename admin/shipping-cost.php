...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <h4 style="background: #dd4b39;color:#fff;padding:10px 20px;">NB: If a district does not exist in the above list, the following "Rest of the World" shipping cost will be applied upon that.</h4>
