...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1) {
        ...
        foreach ($result as $row) {
            $kisan = $row['kisan'];
            unlink('../assets/uploads/'.$kisan);
        }

        // updating the data
        $final_name = 'kisan'.'.'.$ext;
        move_uploaded_file( $path_tmp, '../assets/uploads/'.$final_name );

        // updating the database
        $statement = $pdo->prepare("UPDATE tbl_settings SET kisan=? WHERE id=1");
                                ...
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6" style="padding-top:6px;">
                                            <img src="../assets/uploads/<?php echo $kisan; ?>" class="existing-photo" style="height:80px;">
                                        </div>
                                    </div>
                                    <div class="form-group">
