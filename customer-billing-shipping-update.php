...
if (isset($_POST['form1'])) {
    ...
    $statement->execute(array(
                            ...
                            strip_tags($_POST['cust_b_district']),
    ...
    $_SESSION['customer']['cust_b_district'] = strip_tags($_POST['cust_b_district']);
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="cust_b_district" class="form-control">
                                        <?php
                                        ...
                                        foreach ($result as $row) {
                                            ?>
                                            <option value="<?php echo $row['district_id']; ?>" <?php if($row['district_id'] == $_SESSION['customer']['cust_b_district']) {echo 'selected';} ?>><?php echo $row['district_name']; ?></option>
                                            <?php
                                        }
                                        ?>
                                    </select>
