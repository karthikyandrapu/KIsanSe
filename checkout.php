            ...
            <div class="col-md-12">
                ...
                <div class="cart">
                    <table class="table table-responsive table-hover table-bordered">
                        ...
                        <tr>
                            ...
                            <td><?php echo $arr_cart_weight[$i]; ?></td>
                        ...
                        $statement->execute(array($_SESSION['customer']['cust_district']));
                            ...
                            <table class="table table-responsive table-bordered table-hover table-striped bill-address">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        $statement->execute(array($_SESSION['customer']['cust_b_district']));
                                        $result = $statement->fetchAll(PDO::FETCH_ASSOC);
                                        foreach ($result as $row) {
                            ...
                            <table class="table table-responsive table-bordered table-hover table-striped bill-address">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                        $statement = $pdo->prepare("SELECT * FROM tbl_district WHERE district_id=?");
                                        $statement->execute(array($_SESSION['customer']['cust_s_district']));
                                        $result = $statement->fetchAll(PDO::FETCH_ASSOC);
                                        foreach ($result as $row) {
                                            echo $row['district_name'];
                                        }
                ...
                <div class="row">
		                ...
		                if(
		                    ...
		                    ($_SESSION['customer']['cust_b_district']=='') ||
