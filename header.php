...
<div class="header" style="padding-top: 25px; padding-bottom: 25px;">
	<div class="container">
		<div class="row inner">
			
			<div class="col-md-4 logo">
				<table>
				<th><a href="index.php"><img src="assets/uploads/<?php echo $kisan; ?>" alt="logo image"></a></th>
				<th><h1 style = "font-family: 'Bebas Neue';font-size: 50px; padding-bottom: 10px">KISAN SE</h1></th>
			</table>
			</div>
